...
// property's previous value; and the engine's own six messages —
// `entered`, `left`, `moved`, `spawned`, `tick`, `woke` — bind what the
// spec names them, `elapsed` as an integer and everything else as an
// object.
