...
const bundle = compiledWorld('printers_shop', {
  'world.sprout': [
    'world printers_shop: sprout.World { contains visitors are Person visitors arrive at hall }',
    'enum Glaze { none, shino, tenmoku }',
    'kind Place { contains actors }',
    'kind Room: sprout.Place { :lit true }',
