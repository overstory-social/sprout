// A list, as a world actually holds one (B10; the spec's Properties ›
// Lists).
//
...
import type { HeldType } from './bindings.js';
import { DEFAULT_LIMITS, type StaticCaps } from './limits.js';
import { sameType, showType } from './types.js';
