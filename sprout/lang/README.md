...
| `bundle/`  | limits as host configuration, the manifest, the bundle and its hash, the declaration tables, `compileBundle`, absence, and the generated skill, `generateSkill` |
