...
// occupied places ticked in rounds. The log and the view are B40's and
// B37's. Core imports the language and zod, and nothing else; the store
// is a port an adapter fills.
