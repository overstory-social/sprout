...
- **The visitor kind's own body.** Nothing in it is refused for being behaviour (Open 80); its plays still run, and the fixtures that gave the visitor kind plays their NPCs used now give them to the shared kind.
