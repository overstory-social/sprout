...
- **The visitor kind's own body.** Nothing in it is refused for being behaviour here; decision 80 says what it may declare, and is built by its own issue; its plays still run, and the fixtures that gave the visitor kind plays their NPCs used now give them to the shared kind.
