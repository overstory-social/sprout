...
Generated by the Sprout compiler at language level 1, from its own tables, with the standard library `sprout 0.1.0` (`95f1eba2f3f8`). Every example here was compiled when this was generated, and every message is the compiler’s own; where this page and the compiler disagree, the compiler is right and this page is out of date.
  ...
  "libraries": [
    {
      "name": "sprout",
      "version": "0.1.0",
      "sha": "95f1eba2f3f81e2f4939f52990e472af035b39a14e44effc39d7c0ff1b98da74"
    }
  ],
  "files": [
    "lantern_yard.sprout",
...
| `crowded` | yes | There is no room in {to} for {item}. |
